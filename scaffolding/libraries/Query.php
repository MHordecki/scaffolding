...
class Query_Core 
{
	...
	static public function query($db = NULL, $type = 'SELECT')
	{
		$db or $db = new Database();
	...
	public function __construct($db = NULL, $type = 'SELECT')
	{
		$db or $db = new Database();
		...
		$this->prefix = Kohana::config('database.default.table_prefix');
	}
	...
	public function process()
	{
		...
		return $this->last_query = implode("\n",$ret);
